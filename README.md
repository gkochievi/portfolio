...
```
portfolio/
├── site/                      the portal — a grid, and a page per project     → site/README.md
├── demos/
...
├── vercel.json                Vercel's copy of the fallback rules — it reads only the repo root
...
| Vercel | `/` | `vercel.json`, committed at the repo root |
